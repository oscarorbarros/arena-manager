...
import { Users, Trophy, Newspaper, RefreshCw, Trash2, Database, Clock, FileText, ArrowRight, PlayCircle } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    const stats = [
        { label: "Jogos Ao Vivo", value: config.matches.filter(m => m.status === 'live').length, icon: PlayCircle, color: "text-red-500" },
